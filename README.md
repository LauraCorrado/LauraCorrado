...
- 🌱 I am currently learning **Blender** and **Unity**
- 🧠 My tech stack includes: HTML, CSS, SCSS, JavaScript, VueJS, React, PHP, Laravel, MySQL, jQuery, Vite and tools such as npm, Postman, Git, VS Code and GitHub. I also handle CI/CD pipelines, deployment workflows and production releases for web applications.
